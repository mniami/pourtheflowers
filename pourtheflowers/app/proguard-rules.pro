...
# Podlewacz
-keep class pl.bydgoszcz.guideme.podlewacz.MainActivity { <init>(); }
-keep class pl.bydgoszcz.guideme.podlewacz.PourTheFlowerApplication { <init>(); }
-keep class pl.bydgoszcz.guideme.podlewacz.model.** { *; }
